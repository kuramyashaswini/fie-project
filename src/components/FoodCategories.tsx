...
const FoodCategories = () => {
  const categories = [
    ...
    },
    {
      ...
      description: "Delicious and nutritious midday meals for your busy schedule",
      link: "/food/lunch"
    },
    {
      id: "dinner",
    ...
    <section className="py-16 md:py-24">
      <div className="container mx-auto px-4 md:px-6">
        <div className="text-center mb-12">
          <h2 className="text-3xl md:text-4xl font-bold mb-4">Explore Our Food Categories</h2>
          <p className="text-muted-foreground max-w-2xl mx-auto">
            From breakfast to dinner, we've got all your meals covered with our homemade goodness
          </p>
        </div>
